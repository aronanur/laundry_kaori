        ...
        User
          ...
          .then(response => {
            ...
            let mailOptions = {
              ...
              subject: 'Selamat kamu terdaftar di Kaori Laundry', // Subject line
              text: 'Selamat kamu terdaftar di kaory', // plain text body
              html: 'Selamat ya kamu terdaftar' // html body
            };
